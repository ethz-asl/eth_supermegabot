...
sudo apt-get install liblapack-dev libblas-dev autotools-dev dh-autoreconf \
    ...
    python-wstool python-catkin-tools libssh2-1-dev libatlas3-base libnlopt-dev \
    ccache ros-melodic-octomap ros-melodic-octomap-ros ros-melodic-gps-common \
    "ros-melodic-tf2-*" python-pip python-autopep8 libreadline-dev ifstat \
    ntpdate sysstat libv4l-0
```
