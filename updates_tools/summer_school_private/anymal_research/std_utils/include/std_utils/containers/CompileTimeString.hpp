...
#define TYPESTRING4(n,x) \
        std_utils::tygrab<0x##n##0>(x), std_utils::tygrab<0x##n##1>(x) \
      , std_utils::tygrab<0x##n##2>(x), std_utils::tygrab<0x##n##3>(x)

/* 2^3 = 8 */
#define TYPESTRING8(n,x) \
        std_utils::tygrab<0x##n##0>(x), std_utils::tygrab<0x##n##1>(x) \
      , std_utils::tygrab<0x##n##2>(x), std_utils::tygrab<0x##n##3>(x) \
      , std_utils::tygrab<0x##n##4>(x), std_utils::tygrab<0x##n##5>(x) \
...
#define TYPESTRING16(n,x) \
      ...
      , std_utils::tygrab<0x##n##4>(x), std_utils::tygrab<0x##n##5>(x) \
      , std_utils::tygrab<0x##n##6>(x), std_utils::tygrab<0x##n##7>(x) \
      , std_utils::tygrab<0x##n##8>(x), std_utils::tygrab<0x##n##9>(x) \
      , std_utils::tygrab<0x##n##A>(x), std_utils::tygrab<0x##n##B>(x) \
      , std_utils::tygrab<0x##n##C>(x), std_utils::tygrab<0x##n##D>(x) \
      , std_utils::tygrab<0x##n##E>(x), std_utils::tygrab<0x##n##F>(x)
...
#if USE_TYPESTRING == 0
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING1(,x)>()))
#elif USE_TYPESTRING == 1
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING2(,x)>()))
#elif USE_TYPESTRING == 2
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING4(,x)>()))
#elif USE_TYPESTRING == 3
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING8(,x)>()))
#elif USE_TYPESTRING == 4
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING16(,x)>()))
#elif USE_TYPESTRING == 5
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING32(,x)>()))
#elif USE_TYPESTRING == 6
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING64(,x)>()))
#elif USE_TYPESTRING == 7
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING128(,x)>()))
#elif USE_TYPESTRING == 8
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING256(,x)>()))
#elif USE_TYPESTRING == 9
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING512(,x)>()))
#elif USE_TYPESTRING == 10
#define ct_string(x) \
    decltype(std_utils::typeek(std_utils::typestring<TYPESTRING1024(,x)>()))
#elif USE_TYPESTRING > 10
