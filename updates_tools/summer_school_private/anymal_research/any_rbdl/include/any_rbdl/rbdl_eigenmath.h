...
class ANY_RBDL_DLLAPI Vector3_t : public Eigen::Vector3d
{
	public:
...
class ANY_RBDL_DLLAPI Matrix3_t : public Eigen::Matrix3d
{
	public:
...
class ANY_RBDL_DLLAPI Vector4_t : public Eigen::Vector4d
{
	public:
...
class ANY_RBDL_DLLAPI SpatialVector_t : public Eigen::Matrix<double, 6, 1>
{
	public:
...
class ANY_RBDL_DLLAPI SpatialMatrix_t : public Eigen::Matrix<double, 6, 6>
{
	public:
