...
TEST_F (FloatingBase12DoF, TestSparseFactorizationLTL) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (H, LTL, TEST_PREC, TEST_PREC, "");
}
...
TEST_F (FloatingBase12DoF, TestSparseSolveLx) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (Q, x, TEST_PREC, TEST_PREC, "");
}
...
TEST_F (FixedBase6DoF12DoFFloatingBase, ForwardDynamicsContactsSparse) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (QDDot, QDDot_var1, TEST_PREC, TEST_PREC, "");
}

TEST(SparseFactorization,  TestSparseFactorizationMultiDof) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (x_emulated, x_3dof, 1.0e-9, 1.0e-9, "");
...
TEST(SparseFactorization,  TestSparseFactorizationMultiDofAndFixed) {
	Model model_emulated;
	Model model_3dof;
