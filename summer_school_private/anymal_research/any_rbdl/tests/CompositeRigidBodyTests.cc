...
struct CompositeRigidBodyFixture : ::testing::Test {
...
TEST_F(CompositeRigidBodyFixture, TestCompositeRigidBodyForwardDynamicsFloatingBase) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (QDDot, QDDot_crba, TEST_PREC, TEST_PREC, "");
}
...
//	cout << "H (id) = " << endl << H_id << endl;
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (H_crba, H_id, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(CompositeRigidBodyFixture, TestCompositeRigidBodyForwardDynamicsSpherical) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (H_ref, H, TEST_PREC, TEST_PREC, "");
}
