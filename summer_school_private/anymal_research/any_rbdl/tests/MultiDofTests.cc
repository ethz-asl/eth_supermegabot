...
struct SphericalJoint : public ::testing::Test{
	SphericalJoint () {
		ClearLogOutput();
...
TEST(MultiDof, MultiDofTestQuaternionIntegration ) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (q_zyx_t1, q_t1, 1.0e-5, 1.0e-5, "");
}
...
TEST_F(SphericalJoint, TestGetQuaternion) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (reference_1, quat_1, TEST_PREC, TEST_PREC, "");

	Quaternion reference_3 (-6., -7., -8., -9.);
	Quaternion quat_3 = multdof3_model.GetQuaternion (4, sphQ);
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (reference_3, quat_3, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestSetQuaternion) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (reference_1, test, TEST_PREC, TEST_PREC, "");
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (reference_2, test, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestOrientation) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (emu_orientation, sph_orientation, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestUpdateKinematics) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (emulated_model.v[emu_body_id], multdof3_model.v[sph_body_id], TEST_PREC, TEST_PREC, "");
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (emulated_model.a[emu_body_id], multdof3_model.a[sph_body_id], TEST_PREC, TEST_PREC, "");

	UpdateKinematics (multdof3_model, sphQ, sphQDot, sphQDDot);

	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (emulated_model.v[emu_child_id], multdof3_model.v[sph_child_id], TEST_PREC, TEST_PREC, "");
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (emulated_model.a[emu_child_id], multdof3_model.a[sph_child_id], TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestDynamicsConsistencyRNEA_ABA ) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (sphTau, tau_id, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestCRBA ) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (H_id, H_crba, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestForwardDynamicsLagrangianVsABA ) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (QDDot_lag, QDDot_aba, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestContactsLagrangian) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (emu_force_lagrangian, sph_force_lagrangian, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestContacts) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (emu_force_kokkevis, sph_force_kokkevis, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestEulerZYXvsEmulatedLagrangian ) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (QDDot_emu, QDDot_eulerzyx, TEST_PREC, TEST_PREC, "");
}
...
TEST_F(SphericalJoint, TestEulerZYXvsEmulatedContacts ) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (QDDot_emu, QDDot_eulerzyx, TEST_PREC, TEST_PREC * QDDot_emu.norm(), "");
...
TEST_F(SphericalJoint, TestEulerZYXvsEmulatedCRBA ) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (H_emulated, H_eulerzyx, TEST_PREC, TEST_PREC, "");
}

TEST ( MultiDof,  TestJointTypeTranslationZYX ) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (id_emulated, id_3dof, TEST_PREC, TEST_PREC * id_emulated.norm(), "");
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (qddot_emulated, qddot_3dof, TEST_PREC, TEST_PREC, "");
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (H_emulated, H_3dof, TEST_PREC, TEST_PREC, "");
}

TEST ( MultiDof,  TestJointTypeEulerXYZ ) {
	Model model_emulated;
	Model model_3dof;
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (model_emulated.X_base[3].E, model_3dof.X_base[1].E, TEST_PREC, TEST_PREC, "");
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (model_emulated.v[3], model_3dof.v[1], TEST_PREC, TEST_PREC, "");
...
TEST ( MultiDof,  TestJointTypeEulerYXZ ) {
	Model model_emulated;
	Model model_3dof;
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (id_emulated, id_3dof, TEST_PREC, TEST_PREC, "");
...
TEST_F (Human36, TestUpdateKinematics) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (model_emulated->v[body_id_emulated[BodyPelvis]], model_3dof->v[body_id_3dof[BodyPelvis]], TEST_PREC, TEST_PREC, "");
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (model_emulated->v[body_id_emulated[BodyThighRight]], model_3dof->v[body_id_3dof[BodyThighRight]], TEST_PREC, TEST_PREC, "");
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (model_emulated->v[body_id_emulated[BodyShankRight]], model_3dof->v[body_id_3dof[BodyShankRight]], TEST_PREC, TEST_PREC, "");
}
...
TEST_F (Human36, TestNonlinearEffects) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (nle_emulated, nle_3dof, TEST_PREC, TEST_PREC * nle_emulated.norm(), "");
}
...
TEST_F (Human36, TestContactsEmulatedLagrangianKokkevis) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (qddot_lagrangian, qddot_kokkevis, TEST_PREC, TEST_PREC * qddot_lagrangian.norm(), "");
...
TEST_F (Human36, TestContactsEmulatedLagrangianSparse) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (qddot_lagrangian, qddot_sparse, TEST_PREC, TEST_PREC * qddot_lagrangian.norm(), "");
...
TEST_F (Human36, TestContactsEmulatedLagrangianNullSpace) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (qddot_lagrangian, qddot_nullspace, TEST_PREC, TEST_PREC * qddot_lagrangian.norm(), "");
...
TEST_F (Human36, TestContactsEmulatedMultdofLagrangian) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (qddot_emulated, qddot_3dof, TEST_PREC, TEST_PREC * qddot_emulated.norm(), "");
...
TEST_F (Human36, TestContactsEmulatedMultdofKokkevisSparse) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (qddot_sparse, qddot_kokkevis, TEST_PREC, TEST_PREC * qddot_sparse.norm(), "");
...
TEST_F (Human36, TestContactsEmulatedMultdofKokkevisMultiple ) {
	...
	KINDR_ASSERT_DOUBLE_MX_EQ_ABS_REL (qddot_kokkevis, qddot_kokkevis_2, TEST_PREC, TEST_PREC * qddot_kokkevis.norm(), "");
