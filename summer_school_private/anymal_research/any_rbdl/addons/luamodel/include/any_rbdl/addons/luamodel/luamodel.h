...
namespace Addons {
  ...
  ANY_RBDL_DLLAPI bool LuaModelReadFromFile (const char* filename, Model* model, bool verbose = false);

	ANY_RBDL_DLLAPI bool LuaModelReadFromLuaState (lua_State* L, Model* model, bool verbose = false);
