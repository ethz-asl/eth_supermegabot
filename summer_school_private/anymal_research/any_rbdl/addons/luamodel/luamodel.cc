...
#include "any_rbdl/addons/luamodel/luamodel.h"

#include <iostream>
#include <map>

#include "any_rbdl/addons/luamodel/luatables.h"
...
ANY_RBDL_DLLAPI bool LuaModelReadFromLuaState (lua_State* L, Model* model, bool verbose) {
	assert (model);
