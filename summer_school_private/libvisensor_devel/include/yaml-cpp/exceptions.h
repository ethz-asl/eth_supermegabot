...
namespace YAML
{
	...
	class DSO_EXPORT Exception: public std::runtime_error {
	public:
	...
	class DSO_EXPORT ParserException: public Exception {
	public:
		ParserException(const Mark& mark_, const std::string& msg_)
			: Exception(mark_, msg_) {}
	};

	class DSO_EXPORT RepresentationException: public Exception {
	public:
	...
	class DSO_EXPORT InvalidScalar: public RepresentationException {
	public:
		InvalidScalar(const Mark& mark_)
			: RepresentationException(mark_, ErrorMsg::INVALID_SCALAR) {}
	};

	class DSO_EXPORT KeyNotFound: public RepresentationException {
	public:
		template <typename T>
	...
	template <typename T>
	class DSO_EXPORT TypedKeyNotFound: public KeyNotFound {
	public:
	...
	class DSO_EXPORT InvalidNode: public RepresentationException {
	public:
		InvalidNode()
        : RepresentationException(Mark::null_mark(), ErrorMsg::INVALID_NODE) {}
	};

    class DSO_EXPORT BadConversion: public RepresentationException {
	public:
		BadConversion()
    ...
    template<typename T>
	class DSO_EXPORT TypedBadConversion: public BadConversion {
	public:
		TypedBadConversion()
        : BadConversion() {}
	};

	class DSO_EXPORT BadDereference: public RepresentationException {
	public:
		BadDereference()
		: RepresentationException(Mark::null_mark(), ErrorMsg::BAD_DEREFERENCE) {}
	};

	class DSO_EXPORT BadSubscript: public RepresentationException {
	public:
		BadSubscript()
		: RepresentationException(Mark::null_mark(), ErrorMsg::BAD_SUBSCRIPT) {}
	};

	class DSO_EXPORT BadPushback: public RepresentationException {
	public:
		BadPushback()
		: RepresentationException(Mark::null_mark(), ErrorMsg::BAD_PUSHBACK) {}
	};
	
	class DSO_EXPORT BadInsert: public RepresentationException {
	public:
		BadInsert()
		: RepresentationException(Mark::null_mark(), ErrorMsg::BAD_INSERT) {}
	};

	class DSO_EXPORT EmitterException: public Exception {
	public:
		EmitterException(const std::string& msg_)
		: Exception(Mark::null_mark(), msg_) {}
	};
    
    class DSO_EXPORT BadFile: public Exception {
    public:
