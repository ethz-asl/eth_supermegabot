...
VisualizationPlugin::VisualizationPlugin(common::Console* console)
  ...
  addCommand(
      ...
      [this]() -> int {
        return visualizePointClouds(backend::ResourceType::kRawDepthMap);
      },
  ...
  addCommand(
      ...
      [this]() -> int {
        return visualizePointClouds(backend::ResourceType::kOptimizedDepthMap);
      },
  ...
  addCommand(
      ...
      [this]() -> int {
        return visualizePointClouds(backend::ResourceType::kPointCloudXYZ);
      },
  ...
  addCommand(
      ...
      [this]() -> int {
        return visualizePointClouds(backend::ResourceType::kPointCloudXYZI);
      },
  ...
  addCommand(
      ...
      [this]() -> int {
        return visualizePointClouds(backend::ResourceType::kPointCloudXYZRGBN);
      },
...
int VisualizationPlugin::visualizePointClouds(backend::ResourceType type) {
  std::string selected_map_key;
  if (!getSelectedMapKeyIfSet(&selected_map_key)) {
    return common::kStupidUserError;
  }
  ...
  visualization::visualizePointCloud<vi_map::SensorId>(type, mission_ids, *map);
  visualization::visualizePointCloud<aslam::CameraId>(type, mission_ids, *map);
