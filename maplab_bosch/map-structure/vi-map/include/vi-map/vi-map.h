...
class VIMap : public backend::ResourceMap,
 ...
 public:
  ...
  VISUAL_FRAME_RESOURCE_CONVENIENCE_FUNCTIONS(
      ObjectInstanceBoundingBoxes,
      backend::ResourceType::kObjectInstanceBoundingBoxes,
      resources::ObjectInstanceBoundingBoxes);
  VISUAL_FRAME_RESOURCE_CONVENIENCE_FUNCTIONS(
      ObjectInstanceMasks, backend::ResourceType::kObjectInstanceMasks,
      cv::Mat);
  ...
  OPTIONAL_SENSOR_RESOURCE_CONVENIENCE_FUNCTIONS(
      PointCloudXYZI, aslam::CameraId, backend::ResourceType::kPointCloudXYZI,
      resources::PointCloud);
  OPTIONAL_SENSOR_RESOURCE_CONVENIENCE_FUNCTIONS(
      PointCloudXYZ, aslam::CameraId, backend::ResourceType::kPointCloudXYZ,
      resources::PointCloud);
  ...
  OPTIONAL_SENSOR_RESOURCE_CONVENIENCE_FUNCTIONS(
      ObjectInstanceBoundingBoxes, aslam::CameraId,
      backend::ResourceType::kObjectInstanceBoundingBoxes,
      resources::ObjectInstanceBoundingBoxes);
  OPTIONAL_SENSOR_RESOURCE_CONVENIENCE_FUNCTIONS(
      ObjectInstanceMasks, aslam::CameraId,
      backend::ResourceType::kObjectInstanceMasks, cv::Mat);
